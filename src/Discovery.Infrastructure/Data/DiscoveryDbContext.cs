...
public class DiscoveryDbContext(DbContextOptions<DiscoveryDbContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Ticket>(entity =>
        {
            ...
            entity.Property(ticket => ticket.SlaFirstResponseExpiresAt)
                .HasColumnName("sla_first_response_expires_at")
                .HasColumnType("timestamptz");
            entity.Property(ticket => ticket.FirstRespondedAt)
                .HasColumnName("first_responded_at")
                .HasColumnType("timestamptz");
            entity.Property(ticket => ticket.SlaPausedSeconds)
                .HasColumnName("sla_paused_seconds")
                .HasDefaultValue(0);
            entity.Property(ticket => ticket.SlaHoldStartedAt)
                .HasColumnName("sla_hold_started_at")
                .HasColumnType("timestamptz");
        ...
        modelBuilder.Entity<WorkflowProfile>(entity =>
        {
            ...
            entity.Property(profile => profile.FirstResponseSlaHours)
                .HasColumnName("first_response_sla_hours")
                .HasDefaultValue(4);
            ...
            entity.Property(profile => profile.IsActive)
                .HasColumnName("is_active");
            entity.Property(profile => profile.SlaCalendarId)
                .HasColumnName("sla_calendar_id");
            entity.Property(profile => profile.CreatedAt)
                .HasColumnName("created_at")
                .HasColumnType("timestamptz");
            entity.Property(profile => profile.UpdatedAt)
        ...
        modelBuilder.Entity<TicketSavedView>(entity =>
        {
            ...
            entity.HasIndex(v => v.UserId)
                .HasDatabaseName("ix_ticket_saved_views_user_id");
            entity.HasIndex(v => v.IsShared)
                .HasDatabaseName("ix_ticket_saved_views_is_shared");
            ...
            entity.Property(v => v.Name)
                .HasColumnName("name")
                .HasMaxLength(100);
            entity.Property(v => v.FilterJson)
        ...
        modelBuilder.Entity<CustomFieldDefinition>(entity =>
        {
            ...
            entity.HasIndex(definition => new { definition.ScopeType, definition.Name })
                .HasDatabaseName("ux_custom_field_definitions_scope_name")
                .IsUnique();
            entity.HasIndex(definition => new { definition.ScopeType, definition.IsActive })
                .HasDatabaseName("ix_custom_field_definitions_scope_active");
            ...
            entity.Property(definition => definition.Name)
                .HasColumnName("name")
                .HasMaxLength(100);
            entity.Property(definition => definition.Label)
                .HasColumnName("label")
                .HasMaxLength(200);
            entity.Property(definition => definition.Description)
                .HasColumnName("description")
                .HasMaxLength(1000);
            entity.Property(definition => definition.ScopeType)
                .HasColumnName("scope_type")
                .HasConversion<int>();
            entity.Property(definition => definition.DataType)
                .HasColumnName("data_type")
                .HasConversion<int>();
            entity.Property(definition => definition.IsRequired)
                .HasColumnName("is_required");
            entity.Property(definition => definition.IsActive)
                .HasColumnName("is_active");
            entity.Property(definition => definition.IsSecret)
                .HasColumnName("is_secret");
            entity.Property(definition => definition.OptionsJson)
                .HasColumnName("options_json")
                .HasColumnType("jsonb");
            entity.Property(definition => definition.ValidationRegex)
                .HasColumnName("validation_regex")
                .HasMaxLength(500);
            entity.Property(definition => definition.MinLength)
                .HasColumnName("min_length");
            entity.Property(definition => definition.MaxLength)
                .HasColumnName("max_length");
            entity.Property(definition => definition.MinValue)
                .HasColumnName("min_value")
                .HasColumnType("numeric(18,6)");
            entity.Property(definition => definition.MaxValue)
                .HasColumnName("max_value")
                .HasColumnType("numeric(18,6)");
            entity.Property(definition => definition.AllowRuntimeRead)
                .HasColumnName("allow_runtime_read");
            entity.Property(definition => definition.AllowAgentWrite)
                .HasColumnName("allow_agent_write");
            entity.Property(definition => definition.RuntimeAccessMode)
                .HasColumnName("runtime_access_mode")
                .HasConversion<int>();
            entity.Property(definition => definition.CreatedAt)
                .HasColumnName("created_at")
                .HasColumnType("timestamptz");
            entity.Property(definition => definition.UpdatedAt)
                .HasColumnName("updated_at")
                .HasColumnType("timestamptz");
        });
        ...
        modelBuilder.Entity<CustomFieldValue>(entity =>
        {
            ...
            entity.HasIndex(value => new { value.DefinitionId, value.EntityKey })
                .HasDatabaseName("ux_custom_field_values_definition_entity")
                .IsUnique();
            entity.HasIndex(value => new { value.ScopeType, value.EntityId })
                .HasDatabaseName("ix_custom_field_values_scope_entity");

            entity.Property(value => value.Id)
                .HasColumnName("id")
                .ValueGeneratedNever();
            entity.Property(value => value.DefinitionId)
                .HasColumnName("definition_id");
            entity.Property(value => value.ScopeType)
                .HasColumnName("scope_type")
                .HasConversion<int>();
            entity.Property(value => value.EntityId)
                .HasColumnName("entity_id");
            entity.Property(value => value.EntityKey)
                .HasColumnName("entity_key")
                .HasMaxLength(64);
            entity.Property(value => value.ValueJson)
                .HasColumnName("value_json")
                .HasColumnType("jsonb");
            entity.Property(value => value.UpdatedBy)
                .HasColumnName("updated_by")
                .HasMaxLength(256);
        ...
        modelBuilder.Entity<CustomFieldExecutionAccess>(entity =>
        {
            ...
            entity.HasIndex(access => new { access.DefinitionId, access.TaskId, access.ScriptId })
                .HasDatabaseName("ux_custom_field_execution_access_def_task_script")
                .IsUnique();

            entity.Property(access => access.Id)
                .HasColumnName("id")
                .ValueGeneratedNever();
            entity.Property(access => access.DefinitionId)
                .HasColumnName("definition_id");
            entity.Property(access => access.TaskId)
                .HasColumnName("task_id");
            entity.Property(access => access.ScriptId)
                .HasColumnName("script_id");
            entity.Property(access => access.CanRead)
                .HasColumnName("can_read");
            entity.Property(access => access.CanWrite)
                .HasColumnName("can_write");
            entity.Property(access => access.CreatedAt)
                .HasColumnName("created_at")
                .HasColumnType("timestamptz");
            entity.Property(access => access.UpdatedAt)
                .HasColumnName("updated_at")
                .HasColumnType("timestamptz");

            entity.HasOne<CustomFieldDefinition>()
                .WithMany()
                .HasForeignKey(access => access.DefinitionId)
                .OnDelete(DeleteBehavior.Cascade);
            entity.HasOne<AutomationTaskDefinition>()
                .WithMany()
                .HasForeignKey(access => access.TaskId)
                .OnDelete(DeleteBehavior.Cascade);
            entity.HasOne<AutomationScriptDefinition>()
                .WithMany()
                .HasForeignKey(access => access.ScriptId)
                .OnDelete(DeleteBehavior.Cascade);
        });
        ...
        modelBuilder.Entity<TicketKnowledgeLink>(entity =>
        {
            ...
            entity.Property(l => l.FeedbackUseful).HasColumnName("feedback_useful");
            entity.Property(l => l.FeedbackAt).HasColumnName("feedback_at").HasColumnType("timestamptz");
    ...
    private static void ConfigureP2pEntities(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<AutoTicketRule>(entity =>
        {
            ...
            entity.HasIndex(rule => new { rule.ScopeLevel, rule.IsEnabled })
                .HasDatabaseName("ix_auto_ticket_rules_scope_enabled");
            entity.HasIndex(rule => rule.AlertCodeFilter)
                .HasDatabaseName("ix_auto_ticket_rules_alert_code");
            ...
            entity.Property(rule => rule.IsEnabled)
                .HasColumnName("is_enabled");
            entity.Property(rule => rule.PriorityOrder)
                .HasColumnName("priority_order");
            entity.Property(rule => rule.ScopeLevel)
                .HasColumnName("scope_level")
                .HasConversion<int>();
            entity.Property(rule => rule.ScopeId)
                .HasColumnName("scope_id");
            entity.Property(rule => rule.AlertCodeFilter)
                .HasColumnName("alert_code_filter")
                .HasMaxLength(200);
            entity.Property(rule => rule.SourceFilter)
                .HasColumnName("source_filter")
                .HasConversion<int?>();
            entity.Property(rule => rule.SeverityMin)
                .HasColumnName("severity_min")
                .HasConversion<int?>();
            entity.Property(rule => rule.SeverityMax)
                .HasColumnName("severity_max")
                .HasConversion<int?>();
            entity.Property(rule => rule.MatchLabelsAnyJson)
                .HasColumnName("match_labels_any_json")
                .HasColumnType("jsonb");
            entity.Property(rule => rule.MatchLabelsAllJson)
                .HasColumnName("match_labels_all_json")
                .HasColumnType("jsonb");
            entity.Property(rule => rule.ExcludeLabelsJson)
                .HasColumnName("exclude_labels_json")
                .HasColumnType("jsonb");
            entity.Property(rule => rule.PayloadPredicateJson)
                .HasColumnName("payload_predicate_json")
                .HasColumnType("jsonb");
            entity.Property(rule => rule.Action)
                .HasColumnName("action")
                .HasConversion<int>();
            entity.Property(rule => rule.TargetDepartmentId)
                .HasColumnName("target_department_id");
            entity.Property(rule => rule.TargetWorkflowProfileId)
                .HasColumnName("target_workflow_profile_id");
            entity.Property(rule => rule.TargetCategory)
                .HasColumnName("target_category")
                .HasMaxLength(100);
            entity.Property(rule => rule.TargetPriority)
                .HasColumnName("target_priority")
                .HasConversion<int?>();
            entity.Property(rule => rule.DedupWindowMinutes)
                .HasColumnName("dedup_window_minutes");
            entity.Property(rule => rule.CooldownMinutes)
        ...
        modelBuilder.Entity<AlertCorrelationLock>(entity =>
        {
            ...
            entity.Property(correlationLock => correlationLock.DedupKey)
                .HasColumnName("dedup_key")
                .HasMaxLength(500)
                .ValueGeneratedNever();
            entity.Property(correlationLock => correlationLock.ExpiresAt)
                .HasColumnName("expires_at")
                .HasColumnType("timestamptz");
            entity.Property(correlationLock => correlationLock.LastTicketId)
                .HasColumnName("last_ticket_id");
            entity.Property(correlationLock => correlationLock.LastAlertAt)
        ...
        modelBuilder.Entity<AgentMonitoringEvent>(entity =>
        {
            ...
            entity.HasIndex(monitoringEvent => new { monitoringEvent.AgentId, monitoringEvent.AlertCode, monitoringEvent.OccurredAt })
                .HasDatabaseName("ix_monitoring_events_agent_code_occurred");
            entity.HasIndex(monitoringEvent => new { monitoringEvent.ClientId, monitoringEvent.OccurredAt })
                .HasDatabaseName("ix_monitoring_events_client_occurred");

            entity.Property(monitoringEvent => monitoringEvent.Id)
                .HasColumnName("id")
                .ValueGeneratedNever();
            entity.Property(monitoringEvent => monitoringEvent.ClientId)
                .HasColumnName("client_id");
            entity.Property(monitoringEvent => monitoringEvent.SiteId)
                .HasColumnName("site_id");
            entity.Property(monitoringEvent => monitoringEvent.AgentId)
                .HasColumnName("agent_id");
            entity.Property(monitoringEvent => monitoringEvent.AlertCode)
                .HasColumnName("alert_code")
                .HasMaxLength(200);
            entity.Property(monitoringEvent => monitoringEvent.Severity)
                .HasColumnName("severity")
                .HasConversion<int>();
            entity.Property(monitoringEvent => monitoringEvent.Title)
                .HasColumnName("title")
                .HasMaxLength(200);
            entity.Property(monitoringEvent => monitoringEvent.Message)
                .HasColumnName("message")
                .HasMaxLength(2000);
            entity.Property(monitoringEvent => monitoringEvent.MetricKey)
                .HasColumnName("metric_key")
                .HasMaxLength(200);
            entity.Property(monitoringEvent => monitoringEvent.MetricValue)
                .HasColumnName("metric_value")
                .HasPrecision(18, 4);
            entity.Property(monitoringEvent => monitoringEvent.PayloadJson)
                .HasColumnName("payload_json")
                .HasColumnType("jsonb");
            entity.Property(monitoringEvent => monitoringEvent.LabelsSnapshotJson)
                .HasColumnName("labels_snapshot_json")
                .HasColumnType("jsonb");
            entity.Property(monitoringEvent => monitoringEvent.Source)
                .HasColumnName("source")
                .HasConversion<int>();
            entity.Property(monitoringEvent => monitoringEvent.SourceRefId)
                .HasColumnName("source_ref_id");
            entity.Property(monitoringEvent => monitoringEvent.CorrelationId)
                .HasColumnName("correlation_id")
                .HasMaxLength(128);
            entity.Property(monitoringEvent => monitoringEvent.OccurredAt)
                .HasColumnName("occurred_at")
                .HasColumnType("timestamptz");
            entity.Property(monitoringEvent => monitoringEvent.CreatedAt)
                .HasColumnName("created_at")
                .HasColumnType("timestamptz");
        });
        ...
        modelBuilder.Entity<AutoTicketRuleExecution>(entity =>
        {
            ...
            entity.HasIndex(execution => execution.MonitoringEventId)
                .HasDatabaseName("ix_auto_ticket_rule_executions_event_id");
            entity.HasIndex(execution => new { execution.AgentId, execution.EvaluatedAt })
                .HasDatabaseName("ix_auto_ticket_rule_executions_agent_evaluated");

            entity.Property(execution => execution.Id)
                .HasColumnName("id")
                .ValueGeneratedNever();
            entity.Property(execution => execution.RuleId)
                .HasColumnName("rule_id");
            entity.Property(execution => execution.MonitoringEventId)
                .HasColumnName("monitoring_event_id");
            entity.Property(execution => execution.AgentId)
                .HasColumnName("agent_id");
            entity.Property(execution => execution.EvaluatedAt)
                .HasColumnName("evaluated_at")
                .HasColumnType("timestamptz");
            entity.Property(execution => execution.Decision)
                .HasColumnName("decision")
                .HasConversion<int>();
            entity.Property(execution => execution.Reason)
                .HasColumnName("reason")
                .HasMaxLength(500);
            entity.Property(execution => execution.CreatedTicketId)
                .HasColumnName("created_ticket_id");
            entity.Property(execution => execution.DedupKey)
                .HasColumnName("dedup_key")
                .HasMaxLength(500);
            entity.Property(execution => execution.DedupHit)
                .HasColumnName("dedup_hit");
            entity.Property(execution => execution.PayloadSnapshotJson)
        ...
        modelBuilder.Entity<AgentAlertDefinition>(entity =>
        {
            ...
            entity.HasIndex(alert => alert.Status)
                .HasDatabaseName("ix_agent_alerts_status");
            entity.HasIndex(alert => new { alert.Status, alert.ScheduledAt })
                .HasDatabaseName("ix_agent_alerts_status_scheduled_at");
            entity.HasIndex(alert => new { alert.ScopeType, alert.ScopeClientId })
                .HasDatabaseName("ix_agent_alerts_scope_client");
            entity.HasIndex(alert => new { alert.ScopeType, alert.ScopeSiteId })
                .HasDatabaseName("ix_agent_alerts_scope_site");
            entity.HasIndex(alert => alert.ScopeAgentId)
                .HasDatabaseName("ix_agent_alerts_scope_agent");
            entity.HasIndex(alert => alert.TicketId)
                .HasDatabaseName("ix_agent_alerts_ticket_id");
            ...
            entity.Property(alert => alert.AlertType)
                ...
                .HasConversion<int>();
            entity.Property(alert => alert.TimeoutSeconds)
                .HasColumnName("timeout_seconds");
            entity.Property(alert => alert.ActionsJson)
                .HasColumnName("actions_json")
                .HasColumnType("jsonb");
            entity.Property(alert => alert.DefaultAction)
                .HasColumnName("default_action")
                .HasMaxLength(100);
            entity.Property(alert => alert.Icon)
                .HasColumnName("icon")
                .HasMaxLength(50);
            entity.Property(alert => alert.ScopeType)
                .HasColumnName("scope_type")
                .HasConversion<int>();
            entity.Property(alert => alert.ScopeAgentId)
                .HasColumnName("scope_agent_id");
            entity.Property(alert => alert.ScopeSiteId)
                .HasColumnName("scope_site_id");
            entity.Property(alert => alert.ScopeClientId)
                .HasColumnName("scope_client_id");
            entity.Property(alert => alert.ScopeLabelName)
                .HasColumnName("scope_label_name")
                .HasMaxLength(120);
            entity.Property(alert => alert.Status)
                .HasColumnName("status")
                .HasConversion<int>();
            entity.Property(alert => alert.ScheduledAt)
                .HasColumnName("scheduled_at")
                .HasColumnType("timestamptz");
            entity.Property(alert => alert.ExpiresAt)
                .HasColumnName("expires_at")
                .HasColumnType("timestamptz");
            entity.Property(alert => alert.DispatchedAt)
                .HasColumnName("dispatched_at")
                .HasColumnType("timestamptz");
            entity.Property(alert => alert.DispatchedCount)
                .HasColumnName("dispatched_count");
            entity.Property(alert => alert.TicketId)
                .HasColumnName("ticket_id");
            entity.Property(alert => alert.CreatedBy)
                .HasColumnName("created_by")
                .HasMaxLength(256);
        ...
        modelBuilder.Entity<TicketWatcher>(entity =>
        {
            ...
            entity.HasIndex(w => new { w.TicketId, w.UserId })
                .IsUnique()
                .HasDatabaseName("uq_ticket_watchers_ticket_user");
        });
        ...
        modelBuilder.Entity<TicketAutomationLink>(entity =>
        {
            ...
            entity.HasOne(l => l.AutomationTask)
                .WithMany()
                .HasForeignKey(l => l.AutomationTaskDefinitionId)
                .OnDelete(DeleteBehavior.Restrict);
        });
