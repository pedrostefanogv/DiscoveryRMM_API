    ...
    private void LogResult(string operationName, Guid userId, MeshCentralIdentitySyncResult result)
    {
        if (result.Synced)
        {
            _logger.LogInformation(
                "MeshCentral trigger {OperationName} succeeded for user {UserId}. MeshUserId={MeshUserId}, SiteBindingsApplied={SiteBindingsApplied}, DeviceBindingsApplied={DeviceBindingsApplied}, DeviceBindingsRevoked={DeviceBindingsRevoked}, DeviceBindingsRevocationCandidates={DeviceBindingsRevocationCandidates}",
                operationName,
                userId,
                result.MeshUserId,
                result.SiteBindingsApplied,
                result.DeviceBindingsApplied,
                result.DeviceBindingsRevoked,
                result.DeviceBindingsRevocationCandidates);
            return;
        }
