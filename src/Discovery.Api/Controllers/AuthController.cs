...
public class AuthController : ControllerBase
{
    ...
    public async Task<IActionResult> Login([FromBody] LoginRequestDto dto)
    {
        ...
        {
            return UnauthorizedAuth(ex.Message, "invalid_credentials");
        }
        catch (FormatException)
        {
            return UnauthorizedAuth("Credenciais inválidas.", "invalid_credentials");
        }
    }
    ...
    public async Task<IActionResult> Refresh([FromBody] RefreshTokenRequestDto dto)
    {
        ...
        {
            return UnauthorizedAuth(ex.Message, "refresh_invalid");
        }
        catch (FormatException)
        {
            return UnauthorizedAuth("Refresh token inválido ou expirado.", "refresh_invalid");
        }
    }
