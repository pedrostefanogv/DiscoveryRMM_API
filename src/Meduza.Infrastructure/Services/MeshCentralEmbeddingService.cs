...
public class MeshCentralEmbeddingService : IMeshCentralEmbeddingService
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var query = new Dictionary<string, string>
        {
            ...
            ["meduzaClientId"] = clientId.ToString("D"),
            ["meduzaSiteId"] = agent.SiteId.ToString("D"),
            ["meduzaAgentId"] = agent.Id.ToString("D")
        };
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var query = new Dictionary<string, string>
        {
            ...
            ["hide"] = (hideMask ?? _options.DefaultHideMask).ToString(),
            ["meduzaClientId"] = clientId.ToString("D"),
            ["meduzaSiteId"] = siteId.ToString("D")
        };

        if (agentId.HasValue)
            query["meduzaAgentId"] = agentId.Value.ToString("D");
