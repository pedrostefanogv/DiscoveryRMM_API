...
public sealed record CreateSlaCalendarCommand(string Name, Guid? ClientId, string Timezone, int WorkDayStartHour, int WorkDayEndHour, string WorkDaysJson, bool? IsDefault = null) : ICommand<Result<SlaCalendarDto>>;
public sealed record UpdateSlaCalendarCommand(Guid Id, string? Name, string? Timezone, int? WorkDayStartHour, int? WorkDayEndHour, string? WorkDaysJson, bool? IsDefault = null) : ICommand<Result<SlaCalendarDto>>;
...
/// </summary>
public sealed record SlaCalendarDto(Guid Id, string Name, Guid? ClientId, string Timezone, int WorkDayStartHour, int WorkDayEndHour, string WorkDaysJson, DateTime CreatedAt, DateTime UpdatedAt, int HolidayCount, bool IsDefault = false);

/// <summary>Detalhe do calendário, incluindo os feriados cadastrados.</summary>
public sealed record SlaCalendarDetailDto(Guid Id, string Name, Guid? ClientId, string Timezone, int WorkDayStartHour, int WorkDayEndHour, string WorkDaysJson, DateTime CreatedAt, DateTime UpdatedAt, IReadOnlyList<SlaCalendarHolidayDto> Holidays, bool IsDefault = false);
