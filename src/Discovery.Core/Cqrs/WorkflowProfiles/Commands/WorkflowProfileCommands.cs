...
public sealed record UpdateWorkflowProfileCommand(Guid Id, string? Name, string? Description, int? SlaHours, Guid? SlaCalendarId, int? FirstResponseSlaHours, string? DefaultPriority, bool? IsActive, bool? ClearSlaCalendar = null) : ICommand<Result<WorkflowProfileDto>>;
