...
public sealed record ListKnowledgeArticlesByUserScopeQuery(string? Cursor = null, int Limit = 20, string? Status = null, Guid? DepartmentId = null, string? Category = null) : IQuery<Result<ArticleListPage>>;
