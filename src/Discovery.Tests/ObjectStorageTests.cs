...
/// </summary>
/// <remarks>
/// Estes testes usam <see cref="LocalObjectStorageProvider"/> e são executados apenas com armazenamento local em disco.
/// Não validam conectividade com provedores S3-compatíveis reais.
/// </remarks>
