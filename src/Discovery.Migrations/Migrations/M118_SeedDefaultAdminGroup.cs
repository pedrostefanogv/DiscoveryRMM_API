...
/// <summary>
/// Cria o grupo "Administradores" e vincula admin + role Admin com escopo Global.
///
...
///
/// Esta migration fecha o gap: cria o grupo se não existir, vincula o usuário admin
/// ao grupo e atribui a role Admin com escopo Global.
/// </summary>
...
public class M118_SeedDefaultAdminGroup : Migration
{
    ...
    public override void Up()
    {
        ...
        // 2. Vincula o usuário admin ao grupo (se o usuário existir)
        Execute.Sql($"""
