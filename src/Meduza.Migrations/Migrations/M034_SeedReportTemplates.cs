...
public class M034_SeedReportTemplates : Migration
{
  ...
  ""columns"": [
    ...
    {""field"": ""siteId"", ""width"": 20, ""header"": ""Site""},
    {""field"": ""agentId"", ""width"": 20, ""header"": ""Agent""},
    {""field"": ""osName"", ""width"": 25, ""header"": ""OS Name""},
    {""field"": ""processor"", ""width"": 35, ""header"": ""Processor""},
    {""field"": ""totalMemoryGB"", ""width"": 15, ""header"": ""Memory (GB)""},
    {""field"": ""collectedAt"", ""format"": ""datetime"", ""width"": 20, ""header"": ""Collected""}
  ]
}",
            filters_json = @"{
  ""limit"": 10000,
  ...
  ""orderDirection"": ""DESC""
    ...
    public override void Down()
    {
        ...
        Execute.Sql("DELETE FROM report_templates WHERE created_by = 'migration'");
    }
}
